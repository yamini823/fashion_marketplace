...
const AdminSidebar = ({ isMobileOpen, setIsMobileOpen }) => {
  ...
  const navigation = [
    ...
    { name: 'Seller Applications', href: '/admin/sellers/applications', icon: FileCheck },
    { name: 'Sellers', href: '/admin/sellers', icon: UserCheck },
    { name: 'Product Approvals', href: '/admin/products/pending', icon: PackageSearch },
      ...
      <div className="flex items-center justify-between h-20 px-6 border-b border-brand-100">
        <Link to="/admin/dashboard" className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[0.6rem] uppercase tracking-[0.2em] text-brand-600 mt-1">Admin Panel</span>
          </div>
        </Link>
        <button 
