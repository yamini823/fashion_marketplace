      ...
      <div className="min-h-screen bg-brand-50 flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex items-center justify-center p-4 lg:pl-64">
          <div className="bg-white p-8 md:p-12 rounded-xl shadow-sm max-w-lg w-full text-center border border-brand-200">
            ...
            <h2 className="text-3xl font-serif font-bold text-brand-dark mb-4">Changes Saved</h2>
            <p className="text-brand-600 mb-8 leading-relaxed">
              Product updated successfully. If submitted for approval, it will appear in your store once reviewed.
            </p>
    ...
    <div className="min-h-screen bg-brand-50 flex">
      ...
      <div className="flex-1 flex flex-col lg:pl-64">
        <header className="sticky top-0 z-40 bg-white border-b border-brand-200 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center flex-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-serif font-bold text-brand-dark">Edit Product</h1>
              </div>
            </div>
          </div>
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
          <div className="mb-6">
            <p className="text-brand-600">Update the details of your product listing.</p>
          </div>
          ...
          {productData ? (
            ...
            <div className="p-8 text-center bg-white rounded-xl border border-brand-100 shadow-sm">
              <p className="text-brand-500">Loading product data...</p>
            </div>
          )}
        </main>
      </div>
